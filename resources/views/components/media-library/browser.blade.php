...
@php
    ...
    $folders = $folders instanceof Collection ? $folders : collect($folders ?? []);
    $hasFolders = $folders->isNotEmpty();
    $hasMedia = method_exists($mediaItems, 'isNotEmpty') ? $mediaItems->isNotEmpty() : ! empty($mediaItems);
    $isSelecting = (bool) $selectMode;
        ...
        <div class="card-body">
            <div class="row g-3 align-items-center">
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="h4 mb-0">{{ $libraryStats['total'] ?? 0 }} Files</div>
                    <div class="small text-muted">Images {{ $libraryStats['images'] ?? 0 }} · Videos {{ $libraryStats['videos'] ?? 0 }} · Documents {{ $libraryStats['documents'] ?? 0 }}</div>
                </div>
                <div class="col-xl-3 col-lg-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-outline-secondary" wire:click="goToParent" @disabled($currentFolderId === 0)>
        ...
        <div class="card-body p-0">
            ...
            @else
                ...
                <div class="p-3 border-top">
                    @if (method_exists($mediaItems, 'links'))
                        {{ $mediaItems->links() }}
                    @endif
                </div>
            @endif
