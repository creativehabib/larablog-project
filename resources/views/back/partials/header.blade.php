                ...
                <ul class="header-nav nav">
                    ...
                    <li class="nav-item dropdown header-nav-dropdown has-notified">
                        ...
                        <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                            ...
                            <a href="" class="dropdown-footer">All activities <i class="fas fa-fw fa-long-arrow-alt-right"></i></a>
                        </div><!-- /.dropdown-menu -->
                    </li><!-- /.nav-item -->
                    <!-- .nav-item -->
                    <li class="nav-item dropdown header-nav-dropdown has-notified">
                        ...
                        <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                            ...
                            <a href="" class="dropdown-footer">All messages <i class="fas fa-fw fa-long-arrow-alt-right"></i></a>
                        </div><!-- /.dropdown-menu -->
                    </li><!-- /.nav-item -->
                    <!-- .nav-item -->
