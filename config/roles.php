...
return [
    ...
    UserType::Contributor->value => [
        'label' => 'কন্ট্রিবিউটর',
        'summary' => 'ফ্রিল্যান্সার, অতিথি লেখক বা নতুন রিপোর্টার হিসেবে পোস্ট লিখে রিভিউর জন্য জমা দেন। তাঁদের অনুমতি লেখকের চেয়েও সীমিত—তাঁরা পোস্ট প্রকাশ করতে পারেন না, বেশিরভাগ ক্ষেত্রে মিডিয়া আপলোডের সুযোগও থাকে না। জমা দেওয়ার পর কোনো এডিটর অনুমোদন বা বাতিল না করা পর্যন্ত পোস্টটি আর সম্পাদনা করতে পারেন না।',
        'permissions' => [
            'access_admin_panel',
            'create_posts',
            'submit_posts',
